...
<style>
    ...
    .streamlit-expanderHeader { background-color: transparent !important; color: inherit !important; font-weight: 600; }
</style>
"""
...
<style>
    ...
    /* MAKE THE CARD TITLE POP */
    h3 {
        padding-top: 0px !important;
        margin-bottom: 5px !important;
        font-size: 1.4rem !important;
    }
    /* MAKE STATS GREY AND SMALL */
    .recipe-stats {
        font-size: 0.9rem;
        opacity: 0.8;
        margin-bottom: 10px;
    ...
    for i, item in enumerate(matches):
        ...
        with (col1 if i % 2 == 0 else col2):
            with st.container(border=True):
                ...
                st.markdown(f'<div class="recipe-stats">⏱️ {recipe.get("time", "--")} &nbsp; • &nbsp; 🔥 {recipe.get("calories", "--")}</div>', unsafe_allow_html=True)
